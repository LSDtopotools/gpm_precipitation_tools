...
requirements = ['setuptools==57.5.0','gdal==3.0.4','numpy==1.19.5','pandas==1.3.5','rasterio==1.2.10','scipy==1.4.1','fiona==1.8.21','geopandas==0.10.2','pyproj==3.2.1','utm==0.7.0','matplotlib==3.2.2', 'shapely==1.8.0','rioxarray','xarray', 'PyQt5']
